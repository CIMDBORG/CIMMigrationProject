...
namespace WpfApp1
{
    ...
    //*******************************************************************
    public partial class WeeklyReviewPage : Window
    {
        ...
        public WeeklyReviewPage(WeeklyReviewApps weekly, string[] user_data, List<int> IDListOriginal)
        {
            InitializeComponent();
            page = new Page();
            page = weekly;
            ...
            priorBySystemRow = WeeklyReviewApps.FillWeeklyRow(systems).DefaultView[0];
        ...
        public WeeklyReviewPage(WeeklyReviewApps weekly, string[] user_data, string system, List<int> IDListOriginal)
        {
            InitializeComponent();
            page = new Page();
            page = weekly;
            arr = user_data;
            IDList = IDListOriginal;
            priorBySystemRow = WeeklyReviewApps.FillWeeklyRow(system).DefaultView[0];
        ...
        private void CategoryComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (CategoryComboBox.SelectedIndex == 5)
            {
                ...
                ProcessImprovementCheckBox.Visibility = Visibility.Collapsed;
                CIMValueAddedCheckBox.Visibility = Visibility.Collapsed;
                CIMKnowledgeCheckBox.Visibility = Visibility.Collapsed;
            ...
            else
            {
                ...
                CIMKnowledgeCheckBox.Visibility = Visibility.Visible;
            ...
            if (CategoryComboBox.SelectedIndex == 0)
            {
                ...
                //These are the options for the user in Business Case issues
                else
                {
                        StatusComboBox.Items.Clear();
                        StatusComboBox.Items.Add("Active");
        ...
        private string UserUpdateQuery(string ID)
        {
            ...
            if (CategoryComboBox.Text.ToString() != "Strategic Task")
            {
                query = "UPDATE New_Issues SET Title = '" + TitleText.Text.Replace("'", "\''") + "', User_Update_Bit = 1, User_Update = '" + updatedDate + "', Req_Dept = '" + RequestingDeptComboBox.SelectedItem.ToString() + "', " +
                            "Req_Name = '" + RequestedbyText.Text.ToString() + "', Opened_Date = '" + Startdatepicker.SelectedDate.ToString() + "', Due_Date = " + plannedDate + ", Completed_Date = " + compDate + ", " +
                             "[Status]='" + StatusComboBox.SelectedItem.ToString() + "', " + "Category='" + CategoryComboBox.SelectedItem.ToString() + "', " + "TFS_BC_HDFS_Num=" + BCTI + ", " +
                                    ...
                                    "', New_Bus_Imp = '" + BusinessImpactsText.Text.ToString().Replace("'", "\''") + "', Assigned_To = '" + Owner.Text.ToString() + "', CIMKnow = '" + CIMKnowledgeCheckBox.IsChecked.ToString() + "' " +
                                    "WHERE ID = " + ID + ";";
            }
            else
            {
                query = "UPDATE New_Issues SET Title = '" + TitleText.Text.Replace("'", "\''") + "', User_Update_Bit = 1, User_Update = '" + updatedDate + "', Req_Dept = '" + RequestingDeptComboBox.SelectedItem.ToString() + "', " +
                            "Req_Name = '" + RequestedbyText.Text.ToString() + "', Opened_Date = '" + Startdatepicker.SelectedDate.ToString() + "', Due_Date = " + plannedDate + ", Completed_Date = " + compDate + ", " +
                             "[Status]='" + StatusComboBox.SelectedItem.ToString() + "', " + "Category='" + CategoryComboBox.SelectedItem.ToString() + "', " + "TFS_BC_HDFS_Num=" + BCTI + ", " +
                                    ...
                                    "HP='" + HighPriority.IsChecked.ToString() + "', " +
                                    ...
                                    "OneTimeBenefit=" + OneTimeBenefitText.Text.ToString() + ", " + "AnnualBenefit=" + AnnualBenefitText.Text.ToString() + ", New_Title = '" + TitleText.Text.Replace("'", "\''") + "', New_Sup_Dtls = '" + SupportingDetailsText.Text.ToString().Replace("'", "\''") +
                                    "', New_Bus_Imp = '" + BusinessImpactsText.Text.ToString().Replace("'", "\''") + "', Assigned_To = '" + Owner.Text.ToString() + "' " + ", " + "Annual_Cost_Savings=" + AnnualCost.Text.ToString() +
                                     " WHERE ID = " + ID + ";";
            }
            return query;
        }
        ...
        private string ManagerUpdateQuery(string ID)
        {
            ...
            if (CategoryComboBox.Text.ToString() != "Strategic Task")
            {
                 query = "UPDATE New_Issues SET Manager_Update = '" + updatedDate + "', Manager_Update_Bit = 1, User_Update_Bit = '" + setUserUpdateBit + "', Mgr_Notes = '" + ManagerNotesText.Text.ToString().Replace("'", "\''") + "', " +
                      ...
                      "OneTimeBenefit=" + OneTimeBenefitText.Text.ToString() + ", " + "AnnualBenefit=" + AnnualBenefitText.Text.ToString() + ", " + "Original_Title = '" + TitleText.Text.ToString() + "', " +
                      ...
                      "ManagerReview = '" + ManagerReviewCheckBox.IsChecked.ToString() + "', CIMKnow = '" + CIMKnowledgeCheckBox.IsChecked.ToString() + "' " +
                             "WHERE ID = " + ID + ";";
            }
            else
            {
                query = "UPDATE New_Issues SET Manager_Update = '" + updatedDate + "', Manager_Update_Bit = 1, User_Update_Bit = '" + setUserUpdateBit + "', Mgr_Notes = '" + ManagerNotesText.Text.ToString().Replace("'", "\''") + "', " +
                      ...
                      "ManagerReview = '" + ManagerReviewCheckBox.IsChecked.ToString() + "', CIMKnow = '" + CIMKnowledgeCheckBox.IsChecked.ToString() + "' "  + ", " + "Annual_Cost_Savings=" + AnnualCost.Text.ToString() +
                             " WHERE ID = " + ID + ";";
            }
            return query;
        }
        ...
        private bool UserUpdateReady()
        {
            using (SqlConnection con = new SqlConnection(connectionString))
                try
                {
                    ...
                    string query = "SELECT Original_Title, Original_Sup_Dtls, Original_Bus_Imp FROM New_Issues WHERE ID = " + GetIssueID();
        ...
        //tells us whether or not the user logged in is a manager or not...Paul has manager priviledges for visibility/application maintenence purposes, however he cannot make manager updates
        private bool IsManager()
        {
            if(arr[6] == "Manager" && arr[2] != "Kusiak")
            {
                return true;
            }
            return false;
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
                try
                {
                    ...
                    if (IsManager())
                    {
                        ...
                        MessageBox.Show("Manager Update Successful!");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
                    try
                    {
                        ...
                        string query = "SELECT Title, Req_Dept, Req_Name, Opened_Date, Due_Date, [Status], Category, TFS_BC_HDFS_Num, Sys_Impact, Priority_Number, " +
                                           ...
                                           "Benefits, HP, Deliverables, BCSub FROM New_Issues WHERE ID=" + ID + ";";
